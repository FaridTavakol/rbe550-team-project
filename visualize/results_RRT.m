...
% Import data from C++
raw_filepath = '/home/emmanuel/workspace/ros-workspace/RBE550_ws/results/rrt/1_raw.xyz';
P=importdata(raw_filepath);
hold on;
plot3(P(:,1), P(:,2), P(:,3), 'b', "LineWidth", 0.75);

smooth_filepath = '/home/emmanuel/workspace/ros-workspace/RBE550_ws/results/rrt/1_smooth.xyz';
...
% Import data from C++
raw_filepath = '/home/emmanuel/workspace/ros-workspace/RBE550_ws/results/rrt/2_raw.xyz';
P=importdata(raw_filepath);
hold on;
plot3(P(:,1), P(:,2), P(:,3), 'b', "LineWidth", 0.75);

smooth_filepath = '/home/emmanuel/workspace/ros-workspace/RBE550_ws/results/rrt/2_smooth.xyz';
P=importdata(smooth_filepath);
hold on;
plot3(P(:,1), P(:,2), P(:,3), 'r', "LineWidth", 1);
...
% Import data from C++
raw_filepath = '/home/emmanuel/workspace/ros-workspace/RBE550_ws/results/rrt/3_raw.xyz';
P=importdata(raw_filepath);
hold on;
plot3(P(:,1), P(:,2), P(:,3), 'b', "LineWidth", 0.75);

smooth_filepath = '/home/emmanuel/workspace/ros-workspace/RBE550_ws/results/rrt/3_smooth.xyz';
P=importdata(smooth_filepath);
hold on;
plot3(P(:,1), P(:,2), P(:,3), 'r', "LineWidth", 1);
...
% Import data from C++
raw_filepath = '/home/emmanuel/workspace/ros-workspace/RBE550_ws/results/rrt/4_raw.xyz';
P=importdata(raw_filepath);
hold on;
plot3(P(:,1), P(:,2), P(:,3), 'b', "LineWidth", 0.75);

smooth_filepath = '/home/emmanuel/workspace/ros-workspace/RBE550_ws/results/rrt/4_smooth.xyz';
P=importdata(smooth_filepath);
hold on;
plot3(P(:,1), P(:,2), P(:,3), 'r', "LineWidth", 1);
